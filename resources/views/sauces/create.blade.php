    ...
    <div class="container">
        ...
        <form action="{{ route('sauces.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="manufacturer" id="manufacturer" placeholder="Fabricant" required>
            </div>
            <div class="form-group">
                <label for="description">Description</label>
                <textarea class="form-control" name="description" id="description" rows="3" required></textarea required>
            </div>
            <div class="form-group">
                <label for="mainPepper">Piment principal</label>
                <input type="text" class="form-control" name="mainPepper" id="mainPepper" placeholder="Piment principal" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="slidecontainer d-flex">
                    <input type="range" min="1" max="10" value="5" class="slider" id="heat" name="heat" required>
                    <div style="visibility:hidden"> -> </div>
                    <input type="number" min="1" max="10" value="5" id="heatnum" name="heatnum" width="10px" >
                </div>
            </div>
            <!-- input file de l'image -->
            <div class="form-group">
                <label for="imageUrl">Image</label>
                <input id="img-input" type="file" class="form-control" name="image" id="imageUrl" placeholder="URL de Image" required>
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-primary text-center my-5">Ajouter</button>
            </div>
        </form>
